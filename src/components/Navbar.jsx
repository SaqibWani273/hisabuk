...
const navbarItems = [
  ...
  {
    name: 'My Schedules',
    link: '/activitiesOverview',
  },
  {
    name: 'Templates',
    link: '/myTemplates', // link: '/templates',
  },
  {
    name: 'Progress Tracking',
    link: '/', // link: '/progressTracking',
  },
  {
    name: 'Profile',
    link: '/', // link: '/profile',
    ...
    <nav>
      <div className='container mx-auto flex justify-between items-center py-4 px-6 '>
        <div className='flex'>
          ...
          <p className='text-xl mt-4 items-center font-bold text-green-600 '>
            Hisabuk
          </p>
        </div>
        ...
        <div>
          ...
          <button className='ml-4 px-4 py-2 border rounded-md text-blue-600'>
            Register
          </button>
        </div>
      </div>
      ...
      <div className='container mx-auto flex justify-between items-center py-4 px-6'>
        ...
        <div className='hidden md:flex space-x-6'>
          {navbarItems.map((item) => (
            <li
              key={item}
              className='list-none text-gray-800 hover:text-blue-600'
            >
              <a href=''>{item}</a>
            </li>
          ))}
        ...
        <div className='md:hidden bg'>
          <ul className='flex flex-col items-center space-y-4 py-4'>
            ...
            <div className='flex flex-col space-y-4'>
              ...
              <button className='px-4 py-2 border rounded-md text-blue-600'>
                Register
              </button>
            </div>
          </ul>
    ...
    <nav class=''>
      <div class='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
        <Link to='/' class='flex items-center space-x-3 rtl:space-x-reverse'>
          ...
          <span class='self-center text-2xl font-semibold whitespace-nowrap  font-bold text-green-600'>
            Hisabuk
          </span>
        </Link>
        ...
        <button
          ...
          type='button'
          class='inline-flex items-center p-2 w-10 h-10 justify-center text-sm  rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none   dark:hover:bg-gray-700 '
        >
          <svg
            className='w-6 h-6'
            fill='none'
        ...
        {isOpen && (
          <div
            class='lg:hidden w-full lg:block lg:w-auto dark:bg-gray-900'
            id='navbar-default'
          >
